...
/**
 * LVL Server Class
 * Create separate server instance for LVL location
...
public class LVLServer {
    ...
    public static void main(String[] args) throws Exception {
        final CenterServerImpl lvlServer = new CenterServerImpl(LocationConstants.LAVAL);
        final Registry registry = LocateRegistry.createRegistry(PortConstants.LVL_REGISTRY_PORT);
        registry.bind(LocationConstants.LAVAL, lvlServer);
        ...
        new Thread(() -> {
        	startUdpServer(activityLogger, lvlServer);
        }).start();
    }
