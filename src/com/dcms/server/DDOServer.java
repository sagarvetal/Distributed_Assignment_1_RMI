...
/**
 * DDO Server Class
 * Create separate server instance for DDO location
...
public class DDOServer {
    ...
    public static void main(String[] args) throws Exception {
        final CenterServerImpl ddoServer = new CenterServerImpl(LocationConstants.DOLLARD);
        final Registry registry = LocateRegistry.createRegistry(PortConstants.DDO_REGISTRY_PORT);
        registry.bind(LocationConstants.DOLLARD, ddoServer);
        ...
        /*Start UDP server for Dollard*/
        new Thread(() -> {
        	startUdpServer(activityLogger, ddoServer);
        }).start();
    }
